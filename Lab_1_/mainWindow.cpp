...
void MainWindow::CreateSimpleCalcWidget() {
    ...
    QString StyleSheetNumbers = "QPushButton { color: black; background-color: #F3F3F3; border: none; font: 17pt 'Microsoft YaHei UI'; outline: none;} "
                                "QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px; border-color: #F2F2F2; } "
                                "QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
    QString StyleSheetSigns =   "QPushButton { color: black; background-color: #E6E6E6; border: none; font: 19pt 'Microsoft YaHei UI Light'; outline: none; } "
                                "QPushButton:hover { background-color: #2ECCFA; border-style: solid; border-width: 3px; border-color: #58D3F7; } "
                                "QPushButton:pressed { background-color: #81DAF5; border-style: solid; border-width: 3px; border-color: #A9E2F3; }";
    QString StyleSheetEquals =  "QPushButton { color: black; background-color: #CDE3EE; border: none; font: 19pt 'Microsoft YaHei UI Light'; outline: none; }"
                                "QPushButton:hover { background-color: #2ECCFA; border-style: solid; border-width: 3px; border-color: #58D3F7; } "
                                "QPushButton:pressed { background-color: #81DAF5; border-style: solid; border-width: 3px; border-color: #A9E2F3; }";;
    ...
    pushButtonEquals->setStyleSheet(StyleSheetEquals);
...
void MainWindow::CreateComplCalcWidget() {
    ...
    QString StyleSheetSpecSigns = "QPushButton {color: black; background-color: #E6E6E6; border: none; font: 14pt 'Microsoft YaHei UI Light'; outline: none; } "
                                  "QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px; border-color: #E6E6E6; } "
                                  "QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
    QString StyleSheetSpecRoot =  "QPushButton {color: black; background-color: #E6E6E6; border: none; font: 16pt 'Microsoft YaHei UI Light'; outline: none; } "
                                  "QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px; border-color: #E6E6E6; } "
                                  "QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
...
void MainWindow::CreateDefaultCalcWidget() {
    ...
    //QPushButton* pushButtonSign =      new QPushButton("+/-");
    //QPushButton* pushButtonLBrac =     new QPushButton("(", this);
    //QPushButton* pushButtonRBrac =     new QPushButton(")", this);

    QString StyleSheetBackSpace = "QPushButton { color: black; background-color: #E6E6E6; border: none; font: 17pt 'Microsoft YaHei UI Light'; outline: none; } "
                                  "QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px; border-color: #E6E6E6; } "
                                  "QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
    QString StyleSheetClear =     "QPushButton { color: black; background-color: #E6E6E6; border: none; font: 17pt 'Microsoft YaHei UI'; outline: none; } "
                                  "QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px; border-color: #E6E6E6; } "
                                  "QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
    QString StyleSheetSigns =     "QPushButton { color: black; background-color: #E6E6E6; border: none; font: 19pt 'Microsoft YaHei UI Light'; outline: none; } "
                                  "QPushButton:hover { background-color: #2ECCFA; border-style: solid; border-width: 3px; border-color: #58D3F7; } "
                                  "QPushButton:pressed { background-color: #81DAF5; border-style: solid; border-width: 3px; border-color: #A9E2F3; }";
    QString StyleSheetRadioButton = "QRadioButton {background-color: #E6E6E6; font: 10pt 'Microsoft YaHei UI Light'; padding: 0px 0px 0px 20px;} "
                                    "QRadioButton::indicator { width: 20px; height: 20px; } "
                                    "QRadioButton::indicator::unchecked {image: url(C:/Qt/ProgrammingIntermidiate/Lab_1_final/radio_normal.svg);} "
                                    "QRadioButton::indicator:unchecked:hover {image: url(C:/Qt/ProgrammingIntermidiate/Lab_1_final/radio_normal.svg);} "
                                    "QRadioButton::indicator:unchecked:pressed {image: url(C:/Qt/ProgrammingIntermidiate/Lab_1_final/radio_checked.svg);} "
                                    "QRadioButton::indicator:checked {image: url(C:/Qt/ProgrammingIntermidiate/Lab_1_final/radio_checked.svg);} "
                                    "QRadioButton::indicator:checked:hover {image: url(C:/Qt/ProgrammingIntermidiate/Lab_1_final/radio_checked.svg);} "
                                    "QRadioButton::indicator:checked:pressed {image: url(C:/Qt/ProgrammingIntermidiate/Lab_1_final/radio_checked.svg);}";
    ...
    //pushButtonSign->setStyleSheet(       StyleSheetBackSpace);
    //pushButtonLBrac->setStyleSheet(      StyleSheetSigns);
    //pushButtonRBrac->setStyleSheet(      StyleSheetSigns);
    ...
    //pushButtonSign->setSizePolicy(     QSizePolicy::Preferred, QSizePolicy::Preferred);
    //pushButtonLBrac->setSizePolicy(    QSizePolicy::Preferred, QSizePolicy::Preferred);
    //pushButtonRBrac->setSizePolicy(    QSizePolicy::Preferred, QSizePolicy::Preferred);
    ...
    //defaultCalcLayout->addWidget(pushButtonSign, 2, 0, 1, 3);
    //defaultCalcLayout->addWidget(pushButtonSign,        2, 0, 2, 3);
    defaultCalcLayout->addWidget(pushButtonBackSpace,   2, 3, 2, 1);
    defaultCalcLayout->addWidget(pushButtonClear,       2, 4, 2, 1);
    //simpleCalcLayout->addWidget(pushButtonLBrac,        0, 0, 1, 0);
    //simpleCalcLayout->addWidget(pushButtonRBrac,        0, 1, 1, 1);
    ...
    //connect(pushButtonSign,      SIGNAL(clicked()), this, SLOT(ChangeSignClicked()));
    //connect(pushButtonLBrac,     SIGNAL(clicked()), this, SLOT(LBracketClicked()));
    //connect(pushButtonRBrac,     SIGNAL(clicked()), this, SLOT(RBracketClicked()));
}
...
/*void MainWindow::LBracketClicked(){
    if (ui->lineEdit->text().length()) {
        if (ui->lineEdit->text().at(ui->lineEdit->text().length() - 1) != LEFTBRACKET)
            ui->lineEdit->setText(ui->lineEdit->text() + LEFTBRACKET);
    } else
        ui->lineEdit->setText("0" + LEFTBRACKET + ui->lineEdit->text());
}

void MainWindow::RBracketClicked() {
    if (ui->lineEdit->text().length()) {
        if (ui->lineEdit->text().at(ui->lineEdit->text().length() - 1) != RIGHTBRACKET)
            ui->lineEdit->setText(ui->lineEdit->text() + RIGHTBRACKET);
    } else
        ui->lineEdit->setText("0" + RIGHTBRACKET + ui->lineEdit->text());
}
*/
...
double fact(double N) {
    ...
    if (N == 0.0)
        ...
        return N * fact((int)floor(N) - 1); //floor - возвращение ближайшего целого числа
}
...
void MainWindow::UnFnClicked() {
    ...
    if (expression == "")
        return;
    double number = std::stod(expression); //перевод строки в тип double
    if (symbol == "\u221A") // sqrt
        ...
        while (*(expression.rbegin()) == '0') //r.begin - возврат итератора с operator++, указание на последний элемент
            expression.pop_back(); //удаление последнего символа
        if (*(expression.rbegin()) == SEPARATOR)
            expression.pop_back();
        ui->lineEdit->setText(QString(expression.c_str())); //перевод в строку на С: массив символов с 0 в конце
    }
    expression = std::to_string(number);
...
void MainWindow::Equals() {
    SetDigits(true);
    std::string expression = ui->lineEdit->text().toStdString();
    std::string search_slice = expression.substr(1); //подстрока с первого символа и до конца
    std::string answer = "";
    if (!std::isdigit(*(expression.rbegin())))
        BackSpace(); //если последний символ в строке - не чило
    if (search_slice.find('+') != std::string::npos) { //если + - не последний символ
        std::string::size_type position;
        double left_number  = std::stod(expression, &position);
        double right_number = std::stod(expression.substr(position + 1));
        double answer_number = left_number + right_number; //находим сумму двух чисел
        answer = std::to_string(answer_number);
        while (*(answer.rbegin()) == '0')
            answer.pop_back();
        if (*(answer.rbegin()) == SEPARATOR)
            answer.pop_back(); //переводим . в конец строки
        if (!ui->lineEdit->isEnabled())
            return;
        if (ui->lineEdit->text().length() > 22){
            checkNumber();
    ...
    } else if (search_slice.find('-') != std::string::npos) { //аналогично для -
        std::string::size_type position;
        double left_number  = std::stod(expression, &position);
        double right_number = std::stod(expression.substr(position + 1));
        ...
        if (ui->lineEdit->text().length() > 22){
         ...
         ui->lineEdit->setText(QString(answer.c_str()));
    } else if (search_slice.find("\u00D7") != std::string::npos) { // умножение
        std::string::size_type position;
        double left_number  = std::stod(expression, &position);
        ...
        if (ui->lineEdit->text().length() > 22){
         ...
         ui->lineEdit->setText(QString(answer.c_str()));
    } else if (search_slice.find("\u00F7") != std::string::npos) { // деление
        std::string::size_type position;
        double left_number  = std::stod(expression, &position);
        double right_number = std::stod(expression.substr(position + 2));
        double answer_number = left_number / right_number;
        ...
        if (ui->lineEdit->text().length() > 22){
         ...
         ui->lineEdit->setText(QString(answer.c_str()));
    } else if (search_slice.find(", x\u207F n = ") != std::string::npos) { // возведение в степень - x^n
        std::string::size_type position;
        double left_number  = std::stod(expression, &position);
        ...
        if (ui->lineEdit->text().length() > 22){
            ...
            ui->lineEdit->setText(QString(answer.c_str()));
    } else if (search_slice.find(", \u207F\u221Ax n = ") != std::string::npos) { // обратное возведение в степень - x^(1/n)
        std::string::size_type position;
        double left_number  = std::stod(expression, &position);
